...
do
	...
	BUILD_GRC="$(curl -s 'https://dev.azure.com/mssonic/build/_apis/build/builds?definitions='"${	}"'&branchName=refs/heads/'"${BRANCH}"'&$top=1&resultFilter=succeeded&api-version=6.0' | jq -r '.value[0].id')"
	...
	echo " \"diff\": \"https://github.com/Azure/sonic-buildimage/compare/"${COMMIT_BRCM_1}"..."${COMMIT_BRCM_2}"\"," >> sonic_image_links.json
	...
	echo " \"diff\": \"https://github.com/Azure/sonic-buildimage/compare/"${COMMIT_MLNX_1}"..."${COMMIT_MLNX_2}"\"," >> sonic_image_links.json
	...
	echo " \"diff\": \"https://github.com/Azure/sonic-buildimage/compare/"${COMMIT_VS_1}"..."${COMMIT_VS_2}"\"," >> sonic_image_links.json
	...
	echo " \"diff\": \"https://github.com/Azure/sonic-buildimage/compare/"${COMMIT_INNO_1}"..."${COMMIT_INNO_2}"\"," >> sonic_image_links.json
	...
	echo " \"diff\": \"https://github.com/Azure/sonic-buildimage/compare/"${COMMIT_BFT_1}"..."${COMMIT_BFT_2}"\"," >> sonic_image_links.json
	...
	echo " \"diff\": \"https://github.com/Azure/sonic-buildimage/compare/"${COMMIT_CTC_1}"..."${COMMIT_CTC_2}"\"," >> sonic_image_links.json
	...
	echo " \"diff\": \"https://github.com/Azure/sonic-buildimage/compare/"${COMMIT_CTC64_1}"..."${COMMIT_CTC64_2}"\"," >> sonic_image_links.json
	...
	echo " \"diff\": \"https://github.com/Azure/sonic-buildimage/compare/"${COMMIT_GRC_1}"..."${COMMIT_GRC_2}"\"," >> sonic_image_links.json
	...
	echo " \"diff\": \"https://github.com/Azure/sonic-buildimage/compare/"${COMMIT_MRV_1}"..."${COMMIT_MRV_2}"\"," >> sonic_image_links.json
	...
	echo " \"diff\": \"https://github.com/Azure/sonic-buildimage/compare/"${COMMIT_NPH_1}"..."${COMMIT_NPH_2}"\"," >> sonic_image_links.json
